   ...
   (context "/kouta-indeksoija/api" []
     ...
     (context "/indexer" []
       ...
       (POST "/koodistot" [:as request]
         ...
         :query-params [{koodistot :- String "maakunta,kunta,oppilaitoksenopetuskieli,kansallinenkoulutusluokitus2016koulutusalataso1,kansallinenkoulutusluokitus2016koulutusalataso2,koulutustyyppi,opetuspaikkakk,hakutapa,valintatapajono,pohjakoulutusvaatimuskonfo,lukiopainotukset,lukiolinjaterityinenkoulutustehtava"}]
