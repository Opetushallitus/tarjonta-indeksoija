  ...
  (testing "Fetching hierarkia via cache should"
    (testing "return hierarkia with correct organisation data"
      (let [res (cache/get-hierarkia-cached)]
        (is (= (count (keys @res)) 58))
        (is (= (count (filter #(o/toimipiste? %) (vals @res))) 43))
        (is (= (count (filter #(o/oppilaitos? %) (vals @res))) 10))
        (is (= (count (filter #(o/koulutustoimija? %) (vals @res))) 5))))
    (testing "return correct koulutustoimijat"
      (let [res (cache/get-hierarkia-cached)
            koulutustoimijat (filter #(o/koulutustoimija? (get @res %)) (keys @res))]
        (is (= koulutustoimijat ["1.2.246.562.10.11111111111", "1.2.246.562.10.53814745062", "1.2.246.562.10.73481747332", "1.2.246.562.10.2014041511401945349694", "1.2.246.562.10.55867603791"]))
        (is (= (get @res "1.2.246.562.10.11111111111") {:oid "1.2.246.562.10.11111111111" :status "AKTIIVINEN" :organisaatiotyypit ["organisaatiotyyppi_01"] :childOids ["1.2.246.562.10.54545454545", "1.2.246.562.10.77777777799", "1.2.246.562.10.67476956288"]}))
        (is (= (get @res "1.2.246.562.10.53814745062") {:oid "1.2.246.562.10.53814745062" :status "AKTIIVINEN" :organisaatiotyypit ["organisaatiotyyppi_01"] :childOids ["1.2.246.562.10.112212847610", "1.2.246.562.10.81927839589", "1.2.246.562.10.39218317368"]}))
        (is (= (get @res "1.2.246.562.10.73481747332") {:oid "1.2.246.562.10.73481747332" :status "AKTIIVINEN" :organisaatiotyypit ["organisaatiotyyppi_01", "organisaatiotyyppi_07", "organisaatiotyyppi_09"] :childOids ["1.2.246.562.10.53670619591"]}))
        (is (= (get @res "1.2.246.562.10.2014041511401945349694") {:oid "1.2.246.562.10.2014041511401945349694" :status "AKTIIVINEN" :organisaatiotyypit ["organisaatiotyyppi_01"] :childOids ["1.2.246.562.10.54453921329"]}))
        (is (= (get @res "1.2.246.562.10.55867603791") {:oid "1.2.246.562.10.55867603791" :status "AKTIIVINEN" :organisaatiotyypit ["organisaatiotyyppi_01", "organisaatiotyyppi_07"] :childOids ["1.2.246.562.10.197113642410", "1.2.246.562.10.32506551657"]}))))
    (testing "return correct oppilaitokset"
      (let [res (cache/get-hierarkia-cached)
            oppilaitokset (filter #(o/oppilaitos? (get @res %)) (keys @res))]
        (is (= oppilaitokset ["1.2.246.562.10.53670619591", "1.2.246.562.10.54545454545", "1.2.246.562.10.197113642410", "1.2.246.562.10.77777777799", "1.2.246.562.10.112212847610", "1.2.246.562.10.67476956288", "1.2.246.562.10.54453921329", "1.2.246.562.10.81927839589",
                              "1.2.246.562.10.39218317368", "1.2.246.562.10.32506551657"]))
        ...
        (is (= (get @res "1.2.246.562.10.32506551657") {:childOids ["1.2.246.562.10.37818936132" "1.2.246.562.10.43682075486" "1.2.246.562.10.72599284709"
                                                        ...
                                                        :parentOid "1.2.246.562.10.55867603791" :status "AKTIIVINEN"}))
        (is (= (get @res "1.2.246.562.10.54545454545") {:childOids ["1.2.246.562.10.54545454522", "1.2.246.562.10.54545454511"]
                                                        :oid "1.2.246.562.10.54545454545"
                                                        :kieletUris ["oppilaitoksenopetuskieli_1#2"] :kotipaikkaUri "kunta_091"
        ...
        (is (= (get @res "1.2.246.562.10.67476956288") {:childOids []
                                                        ...
                                                        :parentOid "1.2.246.562.10.11111111111" :status "AKTIIVINEN"}))
        (is (= (get @res "1.2.246.562.10.77777777799") {:childOids ["1.2.246.562.10.777777777993", "1.2.246.562.10.777777777991", "1.2.246.562.10.777777777992"]
                                                        :oid "1.2.246.562.10.77777777799"
                                                        :kieletUris ["oppilaitoksenopetuskieli_1#1"
                                                                     "oppilaitoksenopetuskieli_2#1"] :kotipaikkaUri "kunta_091"
                                                        :nimi {:fi "Oppilaitos fi 1.2.246.562.10.77777777799"
    ...
    (testing "return correct toimipisteet, grandchildren toimipisteet relocated under oppilaitos"
      (let [res (cache/get-hierarkia-cached)
        ...
        (is (= toimipisteet ["1.2.246.562.10.777777777993", "1.2.246.562.10.777777777991", "1.2.246.562.10.61397511793", "1.2.246.562.10.45501388404",
                             ...
                             "1.2.246.562.10.80593660139", "1.2.246.562.10.74168867104", "1.2.246.562.10.73683668492", "1.2.246.562.10.73307006806",
                             "1.2.246.562.10.27277224708", "1.2.246.562.10.42160341923", "1.2.246.562.10.41092748163", "1.2.246.562.10.24134663046",
                             "1.2.246.562.10.72599284709", "1.2.246.562.10.54545454522", "1.2.246.562.10.80117936338", "1.2.246.562.10.33553959546",
                             "1.2.246.562.10.67451633415", "1.2.246.562.10.94997228401", "1.2.246.562.10.82061758015", "1.2.246.562.10.777777777992",
                             "1.2.246.562.10.445049088710", "1.2.246.562.10.38836199083", "1.2.246.562.10.43256000142", "1.2.246.562.10.29631644423",
                             "1.2.246.562.10.74478323608", "1.2.246.562.10.54545454511", "1.2.246.562.10.41941575486", "1.2.246.562.10.92613592937",
                             "1.2.246.562.10.47353291801", "1.2.246.562.10.37753840224", "1.2.246.562.10.94410465259", "1.2.246.562.10.39147468688",
                             "1.2.246.562.10.83918870482", "1.2.246.562.10.19049298185", "1.2.246.562.10.52750255714"]))
