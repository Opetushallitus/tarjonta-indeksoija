      ...
      (with-redefs
        ...
        (is (= (get-search-hakutiedot hakutieto)
               [{:hakuajat [{:alkaa "2031-04-02T12:00", :paattyy "2031-05-02T12:00"} {:alkaa "2032-04-02T12:00", :paattyy "2032-05-02T12:00"}], :hakutapa "hakutapa_02#1", :yhteishakuOid nil, :pohjakoulutusvaatimukset ["pohjakoulutusvaatimuskonfo_002" "pohjakoulutusvaatimuskonfo_003"], :valintatavat ["valintatapajono_av#1" "valintatapajono_tv#1"]}
                ...
                {:hakuajat [{:alkaa "2033-04-02T12:00", :paattyy "2033-05-02T12:00"}], :hakutapa "hakutapa_01#1", :yhteishakuOid "1.2.246.562.29.00000000000000000002", :pohjakoulutusvaatimukset ["pohjakoulutusvaatimuskonfo_007" "pohjakoulutusvaatimuskonfo_006" "pohjakoulutusvaatimuskonfo_005"], :valintatavat []}
                {:hakuajat [{:alkaa "2034-04-02T12:00", :paattyy "2034-05-02T12:00"}], :hakutapa "hakutapa_01#1", :yhteishakuOid "1.2.246.562.29.00000000000000000002", :pohjakoulutusvaatimukset [], :valintatavat ["valintatapajono_cv#1" "valintatapajono_tv#1"]}]))))))
