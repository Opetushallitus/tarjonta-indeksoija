...
(defproject kouta-indeksoija-service "0.4.0-KTO-609-SNAPSHOT"
  ...
  :profiles {:dev {:dependencies [[javax.servlet/javax.servlet-api "3.1.0"]
             ...
             :test {:env {:test "true"} :dependencies [[cloud.localstack/localstack-utils "0.1.22"]
                                                       [fi.oph.kouta/kouta-backend "0.24-SNAPSHOT-KTO-606"]
                                                       [fi.oph.kouta/kouta-backend "0.24-SNAPSHOT-KTO-606" :classifier "tests"]
