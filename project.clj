...
(defproject kouta-indeksoija-service "0.4.1-SNAPSHOT"
  ...
  :profiles {:dev {:dependencies [[javax.servlet/javax.servlet-api "3.1.0"]
             ...
             :test {:env {:test "true"} :dependencies [[cloud.localstack/localstack-utils "0.1.22"]
                                                       [fi.oph.kouta/kouta-backend "0.25-KTO-712-SNAPSHOT"]
                                                       [fi.oph.kouta/kouta-backend "0.25-KTO-712-SNAPSHOT" :classifier "tests"]
